...
<div className="max-w-2xl mx-auto p-6">
  <div className="bg-white rounded-lg shadow-lg p-8">
    <h2 className="text-3xl font-bold text-gray-800 mb-2 text-center">Contact The Savory Table</h2>
    <p className="text-gray-600 mb-8 text-center">We'd love to hear from you. Send us a message!</p>
