      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-2xl font-bold text-white mb-4">The Savory Table</h3>
            <p className="text-sm text-gray-400">
              Bringing delicious recipes and culinary inspiration to your kitchen.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              ...
              <a href="https://pinterest.com" className="hover:text-white transition-colors" aria-label="Pinterest">
